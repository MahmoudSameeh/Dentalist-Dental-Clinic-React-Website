        ...
        <section className='service-section pt-100 pb-70' data-aos="fade-up" data-aos-duration="2000">
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-lg-6 col-sm-6">
                        <p className='service-title-text'>Experience the confidence of a healthy, radiant smile with our expert dental care. We’re here to help you feel amazing about your oral health, one visit at a time.</p>
                    </div>
                </div>
