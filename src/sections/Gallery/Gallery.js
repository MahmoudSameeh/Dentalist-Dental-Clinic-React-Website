        ...
        <section className='gallery-section pt-100 pb-70' data-aos="fade-up" data-aos-duration="2000">
            <div className="container">
                <SectionTitle 
                    ...
                    description="Discover the proof of our exceptional services at Lumina Dental Studio. With satisfied clients, advanced treatments, and a commitment to quality care, we’re dedicated to providing results you can trust."
                />
                <div className="row">
