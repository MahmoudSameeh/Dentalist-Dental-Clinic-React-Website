                ...
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-6 col-md-6">
                        <div className="emergency-text">
                            <SectionTitle subTitle="Dental 24H Emergency" title="Gentle, friendly treatment from our locally practice." description="Experience gentle, friendly treatment at Lumina Dental Studio, where our locally practiced team is committed to providing personalized care in a comfortable and welcoming environment for all our patients."/>
